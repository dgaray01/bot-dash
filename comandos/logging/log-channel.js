...
await message.channel.send("Canal establecido correctamente");
    let datazo = await db.fetch(`logs_${message.guild.id}`)
    let canalzito = this.client.channels.resolve(datazo)
    canalzito.send("Canal de logs puesto")
